...
export const COPY_HAND_TRACKING_LITE =
  'Hand-tracking mode: Child & Inspect on the radial; controllers are required for full Link authoring.'
...
export const COPY_WRIST_VS_RADIAL =
  'Wrist menu: global actions (Library, Undo, Reset view, Recenter…). Node radial: actions for the selected node.'
