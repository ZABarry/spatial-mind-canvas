...
| XR floating panels (search, map history, bookmarks, settings, node detail, help, text prompt) | World-space quads when opened from the wrist menu | Close when finished; avoid stacking multiple heavy panels |
