...
| XR floating panels (search, settings, node detail, help, text prompt) | World-space quads when opened from the wrist menu | Close when finished; avoid stacking multiple heavy panels |
